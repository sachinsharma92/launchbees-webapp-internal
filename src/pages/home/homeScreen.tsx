import { Space, Table, Tag, Button, Col, Row, Card, Input, Switch, Menu, Dropdown, Modal } from 'antd';
import type { ColumnsType } from 'antd/es/table';
import MainLayout from '../../common/mainLayout';
import requireAuth from '../../hocs/requireAuth'
import { ArrowRightOutlined, FilterOutlined, MoreOutlined, PlusCircleOutlined } from '@ant-design/icons';
		...
		<MainLayout>
			...
			>
				<div className="modal-card">
					<h4 className="title4">Sure you want to make the changes?</h4>
					<div className="button-section">
						<Button size="large" className='btn-outline' onClick={() => setStatusModal(false)}>No</Button>
						<Button type="primary" size="large">Yes</Button>
					</div>
				</div>
			</Modal>
		</MainLayout >
